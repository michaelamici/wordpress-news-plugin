<?php
/**
 * Server-side rendering of the `kestrel-courier/breaking-news-template` block.
 *
 * @package WordPress
 */
...
/**
 * Renders the `kestrel-courier/breaking-news-template` block on the server.
 *
 ...
 */
function render_block_kestrel_courier_breaking_news_template( $attributes, $content, $block ) {
...
/**
 * Registers the `kestrel-courier/breaking-news-template` block on the server.
 *
 * @since 5.8.0
 */
...
add_action( 'init', 'register_block_kestrel_courier_breaking_news_template' );
