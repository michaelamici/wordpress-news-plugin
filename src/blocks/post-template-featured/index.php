 ...
 */
function block_core_featured_story_template_uses_featured_image( $inner_blocks ) {
	foreach ( $inner_blocks as $block ) {
		...
		if ( $block->inner_blocks && block_core_featured_story_template_uses_featured_image( $block->inner_blocks ) ) {
			return true;
		}
	}
...
function render_block_kestrel_courier_featured_story_template( $attributes, $content, $block ) {
	...
	if ( block_core_featured_story_template_uses_featured_image( $block->inner_blocks ) ) {
...
function register_block_kestrel_courier_featured_story_template() {
	register_block_type_from_metadata(
		dirname( __DIR__, 3 ) . '/build/blocks/post-template-featured',
		array(
